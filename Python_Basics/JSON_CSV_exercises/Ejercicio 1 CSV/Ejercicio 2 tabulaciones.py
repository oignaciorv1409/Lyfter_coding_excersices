...
def main():
        ...
        save_games_in_file("videogames_tsv.csv", videogames)  
# Despues de un research entiendo que el parametro delimiter="\t", se usa con un archivo .tsv, pero en este caso dejo .csv ya que la clase es de CSV y se puede usar 
